...
-- --------------------------------------------------
-- Date Created: 05/24/2021 14:21:12
-- Generated from EDMX file: E:\Projects\Cine\OrjinalCode\CineBook\CineBookManager\CineBookManager\Models\CineBookEntityDataModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[Device]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[Device];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsOto]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsOto];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsSon]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsSon];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsYdk]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsYdk];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsYdk2]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTheatrePlaceTemplateDetailsYdk2];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTicketDeleted]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTicketDeleted];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTicketSaleDeleted]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTicketSaleDeleted];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTicketSaleOptionDeleted]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTicketSaleOptionDeleted];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[MovieTicketSalePaymentDeleted]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[MovieTicketSalePaymentDeleted];
GO
IF OBJECT_ID(N'[CineBookModelStoreContainer].[PrinterTemplate_20171210]', 'U') IS NOT NULL
    DROP TABLE [CineBookModelStoreContainer].[PrinterTemplate_20171210];
GO
...
-- Creating foreign key on [MovieFormatId] in table 'MovieSession_MovieFormat'
ALTER TABLE [dbo].[MovieSession_MovieFormat]
ADD CONSTRAINT [FK_MovieSession_MovieFormat_MovieFormat]
    FOREIGN KEY ([MovieFormatId])
    REFERENCES [dbo].[MovieFormat]
        ([MovieFormatId])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_MovieSession_MovieFormat_MovieFormat'
CREATE INDEX [IX_FK_MovieSession_MovieFormat_MovieFormat]
ON [dbo].[MovieSession_MovieFormat]
    ([MovieFormatId]);
GO
...
-- Creating foreign key on [MovieSessionId] in table 'MovieSession_MovieFormat'
ALTER TABLE [dbo].[MovieSession_MovieFormat]
ADD CONSTRAINT [FK_MovieSession_MovieFormat_MovieSession]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_MovieSession_MovieFormat_MovieSession'
CREATE INDEX [IX_FK_MovieSession_MovieFormat_MovieSession]
ON [dbo].[MovieSession_MovieFormat]
    ([MovieSessionId]);
GO
