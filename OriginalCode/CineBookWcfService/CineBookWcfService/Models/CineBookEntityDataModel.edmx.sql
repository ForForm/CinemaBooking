...
-- --------------------------------------------------
-- Date Created: 05/24/2021 14:38:11
-- Generated from EDMX file: E:\Projects\Cine\OrjinalCode\CineBook\CineBookWcfService\CineBookWcfService\Models\CineBookEntityDataModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[MovieBookingSerialReservation]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MovieBookingSerialReservation];
GO
...
-- Creating table 'MovieBookingSerialReservation'
CREATE TABLE [dbo].[MovieBookingSerialReservation] (
    [SerialNumber] varchar(20)  NOT NULL,
    [ReservationId] varchar(20)  NULL,
    [Description] nvarchar(50)  NULL,
    [Used] bit  NULL,
    [MovieBookingSerialReservationId] int IDENTITY(1,1) NOT NULL,
    [MovieTheatrePlaceTemplateDetailsId] int  NULL,
    [MovieSessionId] int  NULL,
    [MovieSessionBookingDetailId] int  NULL
);
GO
...
-- Creating primary key on [SerialNumber], [MovieBookingSerialReservationId] in table 'MovieBookingSerialReservation'
ALTER TABLE [dbo].[MovieBookingSerialReservation]
ADD CONSTRAINT [PK_MovieBookingSerialReservation]
    PRIMARY KEY CLUSTERED ([SerialNumber], [MovieBookingSerialReservationId] ASC);
GO
